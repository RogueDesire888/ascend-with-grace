...
import { alchemyItems, breathworkItems, navItems, smoothieItems, taiChiItems, yogaItems } from "./data";
      ...
      <header className="sticky top-0 z-40 border-b border-border/50 bg-background/58 backdrop-blur-2xl">
        <div className="mx-auto flex min-h-20 w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          >
            ...
            <NavDropdown label="Tai Chi" items={taiChiItems} triggerClassName={desktopTrigger} />
            <NavDropdown label="Yoga" items={yogaItems} triggerClassName={desktopTrigger} />
            ...
            <NavDropdown label="Smoothies" items={smoothieItems} triggerClassName={desktopTrigger} />
        ...
        >
          ...
          <div className="shrink-0">
            <NavDropdown label="Tai Chi" items={taiChiItems} triggerClassName={mobileTrigger} />
          </div>
          <div className="shrink-0">
            <NavDropdown label="Yoga" items={yogaItems} triggerClassName={mobileTrigger} />
          </div>
          <div className="shrink-0">
          ...
          <div className="shrink-0">
            <NavDropdown label="Smoothies" items={smoothieItems} triggerClassName={mobileTrigger} />
          </div>
          {trailingNavItems.map((item) => (
            <Link
              key={item.to}
