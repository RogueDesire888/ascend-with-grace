      ...
      <section className="mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-8 lg:py-16">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
            Create your elemental avatar, complete gentle daily quests, unlock interconnected
            healing skill trees, and watch your character glow brighter as you become your highest
            self.
          </p>
        ...
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-bold text-foreground">
              Tiny quests, visible transformation.
            </h2>
          </div>
          <Link
            to="/quests"
