...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A private, supportive community space for sharing progress and joining group healing challenges." },
      { property: "og:title", content: "Supportive Healing Community — Ascend" },
      { property: "og:description", content: "Share progress, receive encouragement, and join calm group challenges." },
    ],
  }),
...
function CommunityPage() {
  return (
    <PageFrame eyebrow="Community" title="A private circle for encouragement, progress, and gentle accountability.">
      <div className="grid gap-6 lg:grid-cols-[1fr_0.85fr]">
        ...
        <aside className="grid content-start gap-5">
          <section className="rounded-[2rem] border border-border/70 bg-card/75 p-6 shadow-[var(--shadow-soft)]">
            ...
            <p className="mt-4 text-muted-foreground">Seven days of soft morning breathwork. Complete with the circle to earn a shared glow bloom.</p>
          ...
          <section className="rounded-[2rem] border border-border/70 bg-card/75 p-6 shadow-[var(--shadow-soft)]">
            ...
            <p className="mt-4 text-muted-foreground">The space is designed for privacy, warmth, consent, and non-performative growth.</p>
          </section>
          <section className="rounded-[2rem] border border-primary/30 bg-[var(--gradient-panel)] p-6 shadow-[var(--shadow-aura)]">
            ...
            <p className="mt-2 text-muted-foreground">Invite support without pressure. Every gentle step counts.</p>
          </section>
        </aside>
      </div>
    </PageFrame>
